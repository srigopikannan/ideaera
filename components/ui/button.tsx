...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-subtle hover:bg-primary/90 hover:shadow-card active:bg-primary/95",
        destructive:
          "bg-error text-error-foreground hover:bg-error/90 shadow-subtle",
        outline:
          "border border-border bg-surface hover:bg-surface-hover text-foreground hover:border-border/80 shadow-subtle",
        secondary:
        ...
        gradient:
          "bg-gradient-to-r from-primary via-indigo-600 to-accent text-white shadow-card hover:opacity-95 hover:shadow-card-hover",
      },
      size: {
