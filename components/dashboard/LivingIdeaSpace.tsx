    ...
    <div className="relative w-full min-h-[calc(100vh-4rem)] p-6 sm:p-12 space-y-10 select-none overflow-x-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/[0.08] pb-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Link
            href="/ideas"
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full border border-white/10 bg-[#0a0c13]/80 hover:bg-white/10 text-neutral-300 hover:text-white text-xs font-mono uppercase tracking-wider transition-all"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        ...
        <div className="lg:col-span-7 relative rounded-3xl border border-white/[0.08] bg-[#07090e] p-8 sm:p-12 overflow-hidden shadow-2xl flex flex-col justify-between min-h-[580px]">
          {/* Background Canvas */}
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="space-y-3 max-w-xl">
              <h2 className="text-3xl sm:text-5xl font-extralight text-white uppercase tracking-tight leading-[1.08]">
                Welcome, {firstName}.
              </h2>
          ...
          <div className="relative z-10 grid grid-cols-3 gap-6 pt-8 border-t border-white/[0.08]">
            <Link href="/ideas" className="space-y-1 group">
              ...
              <span className="text-2xl sm:text-4xl font-mono text-white font-light group-hover:text-indigo-200 transition-colors">
                {totalIdeasCount}
              </span>
            </Link>

            <Link href="/people" className="space-y-1 group">
              ...
              <span className="text-2xl sm:text-4xl font-mono text-white font-light group-hover:text-cyan-200 transition-colors">
                {totalPeopleCount}
              </span>
            </Link>

            <Link href="/hackathons" className="space-y-1 group">
              ...
              <span className="text-2xl sm:text-4xl font-mono text-white font-light group-hover:text-amber-200 transition-colors">
                {totalHackathonsCount}
              </span>
            </Link>
          </div>
